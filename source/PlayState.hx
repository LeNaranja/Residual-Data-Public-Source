...
class PlayState extends MusicBeatState
{
	...
	//Residual Data bg var
	var ourreality:BGSprite;
	...
	override public function create()
	{
		...
		if (isStoryMode)
		{
			...
			detailsText = "Story Mode: Residual Data";
		}
		else
		{
		...
		switch (curStage)
		{
			...
			case 'our reality':
				ourreality = new BGSprite('our-reality', 0, 0, 1, 1, ['Bg glitch'], true);
				ourreality.scale.set(1.5, 1.5);
				//ourreality.scrollFactor.set(0.4, 0.4);
				add(ourreality);
		}
		...
		//vignette
		vignette = new FlxSprite(0, 0).loadGraphic(Paths.image('vignette', 'residual'));
...
//		redvignette.setGraphicSize(FlxG.width, FlxG.height);
		...
		switch (daSong)
		{
			case 'residual-data': //negro al empezar
