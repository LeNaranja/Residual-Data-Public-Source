...
class ChartingState extends MusicBeatState
{
	...
	[
		...
		['Notas de seguimiento', "La camara se mueve segun cuando se toca una en direccion a la misma\nValue 1: True o false para activar\nValue 2: Intensidad, por defecto es 15"]
	];
